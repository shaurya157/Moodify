...
Song.create({title: 'Viva la Vida', artist: 'Coldplay',
            album: 'Death and all his friends', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478198878/art_vivalavida_ed7e9i.jpg',
...
Song.create({title: 'Hymn for the Weekend', artist: 'Coldplay',
            album: 'A Head Full of Dreams', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478278754/hqdefault_nkvcjx.png',
...
Song.create({title: 'Strawberry Swing', artist: 'Coldplay',
            album: 'Death and all his friends', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478198878/220px-Coldplaystrawberryswing_j9emrx.jpg',
...
Song.create({title: 'Stitches', artist: 'Shaw Mendez',
            album: 'Stitches', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478279819/c95185f1364d5a5061a3df99360c41a4_d8nypn.jpg',
...
Song.create({title: 'Ignite', artist: 'Zedd',
            album: 'League of Legends', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478279715/zedd_ignite_huoobq.jpg',
...
Song.create({title: 'A Head Full of Dreams', artist: 'Coldplay',
            album: 'A Head Full of Dreams', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478453323/Coldplay_-_A_Head_Full_of_Dreams_nrngz2.png',
...
Song.create({title: 'Keep the Family Close', artist: 'Drake',
            album: 'Views', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478453949/image5_d8e45p.jpg',
...
Song.create({title: 'Water Under the Bridge', artist: 'Adele',
            album: '25', song_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478454461/adele_m0kokc.jpg',
...
Playlist.create({title: 'Chill', description:'Chill out with your friends with this playlist. Drinks on us!',
                user_id: 1,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478455807/photo-1470486356494-713066102e56_w9c5c7.jpg'})
...
Playlist.create({title: 'Hip-Hop', description:'Featuring the latest tracks poppin off. Have an awesome night with your homies with this playlist',
                user_id: 2,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478474812/hip_hop_xsqy0s.jpg'})

Playlist.create({title: 'Pop', description:'Groove to the beat!',
                user_id: 3,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478474901/photo-1416273567255-8abe875affcd_wllc4l.jpg'})

Playlist.create({title: 'Energize', description:'Electro music flowing through your veins',
                user_id: 4,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475372/photo-1470229722913-7c0e2dbbafd3_g5gikz.jpg'})

Playlist.create({title: 'Romance', description:'Songs for breakups, new romances and everything in between',
                user_id: 5,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475316/Af0sF2OS5S5gatqrKzVP_Silhoutte_zfr604.jpg'})

Playlist.create({title: 'Celebrate', description:'Feel the drop',
                user_id: 6,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475730/photo-1435247220474-1cec0bc7fbc9_xodnag.jpg'})

Playlist.create({title: 'Party', description:'Earworms all day, errday!',
                user_id: 1,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475803/photo-1438557068880-c5f474830377_vma10m.jpg'})
...
Playlist.create({title: 'Happy', description:'Upbeat music for upbeat people',
                user_id: 3,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475722/photo-1472746729193-36ad213ac4a5_nmbfoh.jpg'})

Playlist.create({title: 'Sad', description:'Feels bad man',
                user_id: 4,
                playlist_image_url: 'https://res.cloudinary.com/djv7nouxz/image/upload/q_10/v1478475789/photo-1473861646675-0252edc45daa_goisur.jpg'})
